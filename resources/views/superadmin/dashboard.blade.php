...
<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-8">
    ...
    <x-card>
        <div class="flex items-center justify-between">
            <div>
                <p class="text-muted-foreground text-sm mb-1">Aktif</p>
    ...
    <x-card>
        <div class="flex items-center justify-between">
            <div>
                <p class="text-muted-foreground text-sm mb-1">Nonaktif</p>
...
<x-card class="mt-6">
    <div class="flex items-center justify-between mb-4">
        <h2 class="text-lg font-semibold text-foreground">Tenant Terbaru</h2>
        <a href="{{ route('superadmin.businesses.index') }}" class="text-sm text-secondary hover:text-secondary/80">Lihat Semua</a>
    </div>
    ...
    <div class="overflow-x-auto">
        <table class="w-full text-sm text-foreground">
            ...
            <tbody class="divide-y divide-border">
                ...
                @empty
                    <tr>
                        <td colspan="4" class="px-4 py-8 text-center text-muted-foreground">Belum ada tenant</td>
                    </tr>
                @endforelse
            </tbody>
        </table>
