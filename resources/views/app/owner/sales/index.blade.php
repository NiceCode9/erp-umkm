...
<div class="max-w-screen-xl mx-auto px-4 py-8">
    <div class="flex items-center justify-between mb-6">
        <div>
            ...
            <p class="text-muted-foreground">Semua transaksi penjualan</p>
        </div>
    </div>
        ...
        <tbody>
            @forelse($sales as $sale)
                <tr class="hover:bg-muted/50 transition">
                    ...
                    <td class="px-4 py-3 text-center">
                        <a href="{{ route('app.owner.sales.show', $sale) }}" class="text-secondary hover:text-secondary/80 text-sm">Detail</a>
                    </td>
                </tr>
            @empty
                <tr>
                    <td colspan="8" class="px-4 py-12 text-center text-muted-foreground">Belum ada transaksi penjualan</td>
                </tr>
            @endforelse
        </tbody>
    </x-data-table>
